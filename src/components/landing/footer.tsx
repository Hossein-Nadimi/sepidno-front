        ...
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://t.me/sepidnoapp"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Telegram"
                className="flex size-9 items-center justify-center rounded-lg border hover:bg-accent transition-colors"
              >
                <Send className="size-4" />
              </a>
              <a
                href="https://instagram.com/sepidnoapp"
                target="_blank"
                rel="noopener noreferrer"
